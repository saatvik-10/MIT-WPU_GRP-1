...
class CompanyCardCollectionViewCell: UICollectionViewCell {
    ...
    private var isFlipped = false
       ...
       private func styleFront() {
           ...
           companyNameLabel.font          = UIFont(name: "Georgia-Bold", size: 16)
       ...
       /// Styles the "Tap to see indicators" label directly as a green pill.
       /// Called in awakeFromNib — finds the label by its default xib text.
       private func injectPill() {
           ...
           plainLabel.text            = "● Tap to reveal"
           plainLabel.font            = UIFont.systemFont(ofSize: 12, weight: .medium)
           plainLabel.textColor       = green
           plainLabel.textAlignment   = .center
           plainLabel.backgroundColor = green.withAlphaComponent(0.1)
           plainLabel.layer.cornerRadius = 12
           plainLabel.layer.masksToBounds = true
           plainLabel.numberOfLines   = 1
       }
